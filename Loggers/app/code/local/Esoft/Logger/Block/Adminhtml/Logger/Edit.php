...
class Esoft_Logger_Block_Adminhtml_Logger_Edit extends Mage_Adminhtml_Block_Widget_Form_Container
{
    ...
    public function getHeaderText()
    {
        if( Mage::registry('logger_data') && Mage::registry('logger_data')->getId() ) {
            return Mage::helper('logger')->__("Edit Item '%s'", $this->htmlEscape(Mage::registry('logger_data')->getTitle()));
        } else {
